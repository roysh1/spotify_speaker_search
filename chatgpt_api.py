...
def summarize_episode_content(description, query):
    return completion(f"Summarize this podcast episode description in 1 brief sentence: {description}, if it isn't really relevant for my search, which was {query}, return 'irrelevant'")
